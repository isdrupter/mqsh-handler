...
(function() {
  var Corporal, argv, base64_encode, base64str, basesixfourdecode, basesixfourencode, btchost, btcport, btcpw, btcrpc, btcuser, client, colors, corporal, fs, mqpasswd, mqtt, mquser, pubtopic, readcommand, rpcpassword, rpcuser, servername, shell, startinteractive, subtopic;
  ...
  shell = function() {
    ...
    readcommand.loop(function(err, args, str, next) {
      ...
      if (basesixfourencode === true) {
        ...
        client.publish(pubtopic, sendme, { qos : 1 });
      } else {
        client.publish(pubtopic, args.join(' '), { qos : 1 });
      }
      return next();
    });
  };
  ...
  mqpasswd = "CoXGYlj68fUerpUddTJed4QB";
  ...
  if (argv.U) {
    ...
    client = mqtt.connect('mqtt://' + servername);
    console.log('mqtt.connect ' + servername +  { qos : 1 });
